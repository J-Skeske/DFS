...
data ResponseData = ResponseData { content :: String
...
type API = "load_environment_variables" :> QueryParam "name" String :> Get '[JSON] ResponseData
      :<|> "getFILE"                    :> QueryParam "file" String :> Get '[JSON] Message
      ...
      :<|> "directoryContents"          :> QueryParam "path" FilePath  :> Get '[JSON] Filesp
